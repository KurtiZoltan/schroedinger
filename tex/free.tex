Az $F=0$ eset megoldása az egyik legalapvetőbb példa egyszerű kvantummechanikai rendszerekre. A sajátfüggvények
\begin{equation}
...
\end{equation}
Ezek az energiaszintek hasznosak lesznek a numerikus számításokban az $F\neq 0$ eseten is, \aref{numeric:timesection}. fejezetben leírt algoritmus miatt.