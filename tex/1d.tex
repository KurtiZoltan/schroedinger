Az egy dimenziós probléma tárgyalásának két esete van aszerint, hogy $\boldsymbol{F}$ megfelelő komponense $0$-e. Amennyiben a komponens $0$, a feladat a szabad részecske utáni legelemibb probléma megoldása: a végtelen potenciálgödör. Amennyiben $\boldsymbol{F}$ komponense nem 0, a megoldandó egyenlet az Airy-egyenletre \cite{beals_wong_2010} hasonlít, és az Airy függvények rövid vizsgálata után az energia sajátfüggvényeket megadjuk az Airy függvények kombinációjaként.
