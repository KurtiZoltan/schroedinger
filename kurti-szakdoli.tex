...
\newcommand{\Ai}[0]{\mathrm{Ai}}
\newcommand{\Bi}[0]{\mathrm{Bi}}
\newcommand{\Aip}[0]{\mathrm{Ai}^\prime}
\newcommand{\Bip}[0]{\mathrm{Bi}^\prime}
\newcommand{\Ti}[0]{\mathrm{Ti}}
...
\section{A dobozba zárt részecske Schrödinger-egyenlete}
	...
	\subsection{Egy dimenzióban}
		...
		\subsubsection{Airy függvények}
			\input{tex/airy.tex}
		\subsubsection{Kitekintés: szabad részecske gyorsuló koordinátarendszerben}
...
\section{Szemiklasszikus közelítés}
	...
	\subsection{Össehasonlítás az egzakt eredménnyel}
